            ...
            >
              ...
              <div className="space-y-4">
                <div className="space-y-1">
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Genuine Series</p>
        ...
        <div className="mt-12 bg-[#1447E6] rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden group hover:bg-[#006699] transition-all duration-500">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="text-center md:text-left space-y-2">
              ...
              <p className="text-white/70 font-medium max-w-md">Our specialists provide customized solutions for enterprises and large teams.</p>
            </div>
